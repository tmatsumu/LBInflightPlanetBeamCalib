...
def curvefitfunc_ellipGauss((X,Y), x0,y0,sigma_x,sigma_y,theta,A):
...
#        print len(ind[0])
        ...
        Brout_std.append(np.std(np.abs(Br[ind])))
...
#from https://www.cosmos.esa.int/web/herschel/calibrator-models#neptune,note that we use neptune_esa5.fits
    ...
    sigma_r_rad = sigma_r * pi / 10800 / np.sqrt(8.*np.log(2))
