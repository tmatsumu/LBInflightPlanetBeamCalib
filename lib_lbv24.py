...
def Dpixmm_info_PhaseA1_HFTv24(FreqWafer):
...
def Telescope_info(LHFT):
	if LHFT == 'LFT': Fnum = 3.5; BeamWaistFact = 2.6; radius = 400.e-3/2.
	if LHFT == 'reflect_HFT_MF': Fnum = 3.5; BeamWaistFact = 2.6; radius = 300.e-3/2.
	if LHFT == 'refract_HFT_HF': Fnum = 2.2; BeamWaistFact = 3.1; radius = 300.e-3/2.
