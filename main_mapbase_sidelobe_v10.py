...
FreqWafer_arr = Gen_ArrFreqWafer(Telescope)
...
#radius = 400.e-3/2.
  ...
  nu_obsGHz = lbv24.nuobsGHz_FreqWafer(FreqWafer,Telescope)
  nu_obs = nu_obsGHz*1.e9
  Dpixmm = lbv24.Dpixmm_info_PhaseA1_v27(FreqWafer,Telescope)
  edgetaper = lbv24.CalcSEdgeTaper_v27(nu_obs,Fnum,Dpixmm,BeamWaistFact,Telescope)
  beam_arcmin = lbv24.beamarcmin_info_PhaseA1(nu_obsGHz,Telescope)
